...
<html lang="en">
  ...
  <body class="nav-md">
                          ...
                          <tbody>
                            ...
                            <tr>
                              ...
                              <td width="150" align="center">
                                <a href=""  onclick="editData(event, '<?=$data_user['id_user'];?>', '<?=$data_user['nik_user'];?>', '<?=$data_user['nama_ustadz'];?>', '<?=$data_user['username'];?>','<?=$data_user['password'];?>','<?=$data_user['role'];?>')"><i class="fa fa-edit"></i> Edit</a>
                ...
                <form role="form" action="<?=base_url();?>admin/user/edit" method="post">
                  <div class="form-group col-md-12 col-sm-12">
                    <input type="hidden" name="id_user" id="id_user" value=""/>
                     <input type="hidden" name="nik_user_edit" id="nik_user_edit" value=""/>
                    <label class="col-form-label col-md-3 col-sm-3 label-align">Nama: </label>
                    <div class="col-md-8 col-sm-8 ">
                      <input class="form-control" type="text" id="nama_user_edit" name="nama_user" placeholder="Nama" value=""/>
                    </div>
                  </div>
                  <div class="form-group col-md-12 col-sm-12">
    ...
    <script type="text/javascript">
      ...
      function editData(e,id,nik,nama,username,password,role){
        e.preventDefault();
        $("#id_user").val(id);
