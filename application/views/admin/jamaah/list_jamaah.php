                          ...
                          ?>
                            <tr>
                              ...
                              <td width="150" align="center">
                                ...
                                <a href="" onclick="deleteConfirm(event,'<?=base_url();?>/admin/jamaah/hapus/<?=$data_jamaah['id_jamaah'];?>')"><i class="fa fa-trash"></i> Hapus</a></td>
                            </tr>
                            <?php $j++; ?>
                            <?php endforeach; ?>
                          </tbody>
              ...
              <div class="modal-body">
                <div class="col-md-12 col-sm-12">  
                    ...
                    <div class="item form-group">
                      ...
                      <div class="col-md-8 col-sm-8 ">
                        <input class="form-control" type="number" name="telepon_jamaah" placeholder="Telepon" value="<?= set_value('telepon_jamaah'); ?>" required/>
                      </div>
                    </div>
