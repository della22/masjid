(function ($) {
  ...
  $.fn.updateCalendarOptions2 = function (options2) {
    var updatedOptions2 = $.extend(settings, options2);
    var calendarInitFn2 = $.fn.calendar.bind(this);
    calendarInitFn2(updatedOptions2);
  };
