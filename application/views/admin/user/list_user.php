                          ...
                          ?>
                            <tr>
                              ...
                              <td width="150" align="center">
                                ...
                                <a href="" onclick="deleteConfirm(event,'<?= base_url(); ?>/admin/user/hapus/<?= $data_user['id_user']; ?>')"><i class="fa fa-trash"></i> Hapus</a>
                              </td>
                            </tr>
                            <?php $j++; ?>
                          <?php endforeach; ?>
          ...
          <form role="form" action="<?= base_url(); ?>admin/user/edit" method="post">
            <div class="form-group col-md-12 col-sm-12">
              ...
              <div class="col-md-8 col-sm-8 ">
                <select class="js-example-basic-single-edit" id="id_jamaah_edit" style="width: 100%;border-radius:none" name="id_jamaah">
                  <option value=""></option>
          ...
          <div class="col-md-12 col-sm-12">
            <form action="<?= base_url(); ?>admin/user/proses" method="post" enctype="multipart/form-data">
              <div class="item form-group">
                ...
                <div class="col-md-8 col-sm-8 ">
                  <select class="js-example-basic-single" style="width: 100%;border-radius:none" name="id_jamaah">
                    <option value=""></option>
                    <?php foreach ($jamaah->result_array() as $data_jamaah) :
                    ?>
                      <option value="<?= $data_jamaah['id_jamaah']; ?>"><?= $data_jamaah['nama_jamaah']; ?></option>
